...
export class D2PluginModal extends Modal {
  diagram: any;
  plugin: D2Plugin;
  ...
  onOpen() {
    ...
    modalParentEl?.classList.add('modal-d2');
    const modalCloseBtn = modalParentEl?.querySelector('.modal-close-button');
    modalCloseBtn?.classList.add('modal-d2-closeBtn');
    contentEl.classList.add('modal-d2-content');
